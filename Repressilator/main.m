...
distlma = solhm(end,1:M)+solhm(end,M+1:2*M);
distlma = max(distlma,zeros(1,M));
plot(0:maxm-1,distlma(1:maxm),'.','MarkerSize',18,'color',[0.47,0.67,0.19]); hold on
